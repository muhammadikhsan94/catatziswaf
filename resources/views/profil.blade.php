    ...
    <form id="editUser" class="form-horizontal" method="post" action="javascript:void(0)" enctype="multipart/form-data">
        ...
        <div class="box-body">
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-5">
                    <a class="btn btn-default" id="buka_password">Ubah Password</a>
                    <a class="btn btn-default" id="tutup_password">Batal Ubah Password</a>
                </div>
            </div>

            <div id="tampil_password">
                <div class="form-group">
                    <label for="old_password" class="col-sm-3 control-label">Password Lama</label>
                    <div class="col-sm-5">
                        <input type="password" class="form-control" id="old_password" name="old_password" placeholder="Masukkan Password Lama" oninvalid="this.setCustomValidity('data tidak boleh kosong!')" onchange="setCustomValidity('')">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="new_password_confirm" class="col-sm-3 control-label">Ulangi Password Baru</label>
                    <div class="col-sm-5">
                        <input type="password" class="form-control" id="new_password_confirm" name="new_password_confirm" placeholder="Masukkan Password Baru Lagi" oninvalid="this.setCustomValidity('data tidak boleh kosong!')" onchange="setCustomValidity('')">
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tampil_password').hide();
        $('#tutup_password').hide();

        $('#buka_password').click(function() {
            $('#tampil_password').show();
            $('#tutup_password').show();
            $('#buka_password').hide();
            $('#tutup_password').click(function() {
                $('#tampil_password').hide();
                $('#tutup_password').hide();
                $('#buka_password').show();
            });
